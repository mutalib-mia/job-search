                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="single-blog hover-effect">
                                    <div class="blog-image box-hover">
                                        <a href="#" class="block">
                                            <img src="{{ asset('frontEndAssets') }}/images/blog/4.jpg" alt="">
                                        </a>
                                    </div>
                                    <div class="blog-text">
                                        <h4><a href="blog-details.html">Standard blog post.</a></h4>
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="single-blog hover-effect">
                                    <div class="blog-image box-hover">
                                        <a href="#" class="block">
                                            <img src="{{ asset('frontEndAssets') }}/images/blog/5.jpg" alt="">
                                        </a>
                                    </div>
                                    <div class="blog-text">
                                        <h4><a href="blog-details.html">Standard blog post.</a></h4>
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="single-blog hover-effect">
                                    <div class="blog-image box-hover">
                                        <a href="#" class="block">
                                            <img src="{{ asset('frontEndAssets') }}/images/blog/6.jpg" alt="">
                                        </a>
                                    </div>
                                    <div class="blog-text">
                                        <h4><a href="blog-details.html">Standard blog post.</a></h4>
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="single-blog hover-effect">
                                    <div class="blog-image box-hover">
                                        <a href="#" class="block">
                                            <img src="{{ asset('frontEndAssets') }}/images/blog/7.jpg" alt="">
                                        </a>
                                    </div>
                                    <div class="blog-text">
                                        <h4><a href="blog-details.html">Standard blog post.</a></h4>
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="single-blog hover-effect">
                                    <div class="blog-image box-hover">
                                        <a href="#" class="block">
                                            <img src="{{ asset('frontEndAssets') }}/images/blog/8.jpg" alt="">
                                        </a>
                                    </div>
                                    <div class="blog-text">
                                        <h4><a href="blog-details.html">Standard blog post.</a></h4>
