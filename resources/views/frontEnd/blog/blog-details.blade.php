                    ...
                    <div class="comments fix pt-55">
                        ...
                        <div class="single-comment fix mb-30">
                            <div class="author-image">
                                <img alt="" src="{{ asset('frontEndAssets') }}/images/comment/1.jpg">
                            </div>
                        ...
                        <div class="single-comment fix mb-30 ml-130">
                            <div class="author-image">
                                <img alt="" src="{{ asset('frontEndAssets') }}/images/comment/2.jpg">
                            </div>
                            <div class="comment-text fix">
                                <div class="author-info">
                        ...
                        <div class="single-comment fix mb-30">
                            <div class="author-image">
                                <img alt="" src="{{ asset('frontEndAssets') }}/images/comment/3.jpg">
                            </div>
                            <div class="comment-text fix">
                                <div class="author-info">
